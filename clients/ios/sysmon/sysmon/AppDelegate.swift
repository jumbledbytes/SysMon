...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // pass context to each class that is going to use it
        LoginViewController.managedObjectContext = self.managedObjectContext
        
        // Clear the badge icon indicating notifications are acknowledges
    ...
    func application(application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData) {
        ...
        self.deviceToken = String(tokenString);
        ...
        controller.deviceToken = tokenString;
    ...
    func application(application: UIApplication, didReceiveRemoteNotification userInfo: [NSObject : AnyObject]) {
        ...
        // acknowledge receipt of notification by saving our device token with the server
        // TODO: This doesn't work
        if(dataSource != nil) {
            dataSource?.saveDeviceToken(deviceName, deviceToken: deviceToken);
        }
    }
    ...
    func splitViewController(splitViewController: UISplitViewController, collapseSecondaryViewController secondaryViewController:UIViewController, ontoPrimaryViewController primaryViewController:UIViewController) -> Bool {
        ...
        if topAsDetailController.detailTest == nil {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.jumbledbytes.coredatatest" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("SysMonDataModel", withExtension: "momd")!
